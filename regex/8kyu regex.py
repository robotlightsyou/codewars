...
You're on your way to the market when you hear beautiful music coming from a nearby street performer. The notes
come together like you wouln't believe as the musician puts together patterns of tunes. As you wonder what kind
...
def is_lock_ness_monster(string):
    nessReg = re.compile(r"tree fiddy|3.50|three fifty")
    mo = nessReg.search(string)
    if mo != None:
        return True
    else:
        return False
